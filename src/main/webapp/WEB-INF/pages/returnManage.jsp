...
<table id="dg" class="easyui-datagrid" title="归还单" fit="true"
    ...
    <tr>
        ...
        <th data-options="field:'rentBillNo',width:100">出租单号</th>
...
<div id="editPanel" class="easyui-dialog" title="编辑" style="padding:10px;width:650px;height:450px;"
    ...
    <form id="editForm" method="post">
        ...
        <table>
            ...
            <tr>
                <td>出租单号</td>
                <td><input class="easyui-textbox" type="text" name="rentBillNo" style="width:100px">
                </td>
            ...
            <tr>
                <td>租用天数</td>
                <td><input id="days" class="easyui-numberbox" type="text" name="rentDay" style="width:100px">
                </td>
                <td></td>
            </tr>
            <tr>
