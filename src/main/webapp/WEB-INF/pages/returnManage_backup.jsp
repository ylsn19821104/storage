...
<table id="dg" class="easyui-datagrid" title="归还单" fit="true"
    ...
    <tr>
        ...
        <th data-options="field:'billNo',width:80">单号编号</th>
        <th data-options="field:'stat',width:80">单据状态</th>
    ...
    <tr>
        ...
        <th data-options="field:'returnBillNo',width:100">出租单号</th>
...
<div id="editPanel" class="easyui-dialog" title="编辑" style="padding:10px;width:650px;height:450px;"
    ...
    <form id="editForm" method="post">
        ...
        <table>
            <tr>
                <td>归还单号</td>
                <td><input class="easyui-textbox" type="text" name="billNo" style="width:100px"
            ...
            <tr>
                <td>物流公司</td>
                <td><input class="easyui-textbox" type="text" name="logisticsCompany" style="width:100px">
                </td>
                <td>快递单号</td>
            ...
            <tr>
                <td>租用天数</td>
                <td><input id="days" class="easyui-numberbox" type="text" name="returnDay" style="width:100px">
                </td>
                <td></td>
            </tr>
            <tr>
                <td>租金总金额</td>
                <td><input class="easyui-numberbox" type="text" name="returnMoney" style="width:100px">
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>赔偿总金额</td>
                <td><input class="easyui-numberbox" type="text" name="damageMoney" style="width:100px">
                </td>
                <td></td>
            </tr>
        </table>
    ...
    <div id="t2_panel">
        <table id="t2_dg" class="easyui-datagrid" title="归还明细"
               data-options="pagination:'true',rownumbers:true,singleSelect:false,url:'${pageContext.request.contextPath}/returnDtl/list',method:'get',toolbar:'#t2_menu'">
            <thead>
            <tr>
                <th field="cb" checkbox="true" align="center"></th>
                ...
                <th data-options="field:'itemRent',width:80">金额</th>
                <th data-options="field:'itemRepo',width:60,align:'center'">押金</th>
                <th data-options="field:'itemDamage',width:60,align:'center'">押金</th>
        ...
        <div id="t2EditPanel" class="easyui-dialog" title="编辑" style="padding:10px;width:550px;"
            ...
            <form id="t2EditForm" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td>赔偿金</td>
                        <td><input class="easyui-numberbox" type="text" name="itemDamage" style="width:150px">
                        </td>
