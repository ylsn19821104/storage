...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/ycrk.js"></script>
</head>
<body>
<table id="dg" class="easyui-datagrid" title="移仓入库单" fit="true" 
       data-options="pagination:'true',rownumbers:true,singleSelect:false,selectOnCheck:true,url:'${pageContext.request.contextPath}/ycrk/list',method:'get',toolbar:'#menu'">
    ...
    <tr>
        ...
        <th data-options="field:'total',width:100">移仓入库总数</th>
    ...
    <form id="editForm" method="post">
    	...
    	<table cellspacing="8px">
            ...
            <tr>
            	<td>制单员</td>
                <td>
                    <select class="easyui-combobox" name="makerId" style="width:173px;" data-options="
                    valueField: 'id',
                    textField: 'text',
                    url: '${pageContext.request.contextPath}/user/comboList'">
                    </select>
                </td>
            </tr>
   		</table>
    ...
    <div id="t2_panel">
        <table id="t2_dg" class="easyui-datagrid" title="移仓入库明细"
            ...
            <tr>
                ...
                <th data-options="field:'locationName',width:80">入库仓位</th>
                <th data-options="field:'skuAmount',width:80">Sku数量</th>
                <th data-options="field:'inAmount',width:80,align:'right'">入库数量</th>
            </tr>
            </thead>
        </table>
            ...
            <form id="t2EditForm" method="post">
                ...
                <table>
                    ...
                    <tr>
		                ...
		                <td>Sku库存</td>
                        <td><input class="easyui-numberbox" type="text" name="skuAmount" id="itemPrice" style="width:173px" 
                        data-options="min:0,required:true"></td>
            		</tr>
                    <tr>
                        <td>入库数量</td>
                        <td><input class="easyui-numberbox" type="text" name="inAmount" id="itemPrice" style="width:173px" 
                        data-options="min:0,required:true"></td>
                    </tr>
